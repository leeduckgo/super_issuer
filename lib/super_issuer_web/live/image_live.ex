defmodule SuperIssuerWeb.ImageLive do
  ...
  def render(assigns) do
    ...
    <div style="margin-left: <%= @depth * 50 %>px;">
      ...
      <br/>
      <img phx-click="boom" src="<%= Routes.static_path(SuperIssuerWeb.Endpoint, "/images/phoenix.png") %>" width="<%= @width %>" style="background: <%= @bg %>;" />
    </div>
    """
  end
